...
// import apiService from "../../../services/apiService"; // Temporairement désactivé
  ...
  useEffect(() => {
    const fetchNotifications = async () => {
      ...
      if (result.success) {
        ...
        console.warn("Notifications non disponibles:", result.error);
        setNotifications(result.data || []); // Fallback automatique du service
      }
    };
